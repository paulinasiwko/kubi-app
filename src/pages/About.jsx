        ...
        <Container fluid className="p-0">
            ...
            <Row className="text-center m-5 px-lg-5">
                <Col>
                    ...
                    <p>
                        W naszej ofercie znajdują się <b className="bold">zabudowy kuchenne, szafy, garderoby, meble
                        pokojowe,
            ...
            <Row className="greyRow g-0">
                <Col xs={12} md={6} className="px-5 text">
                    <h5 className="fw-semibold mb-4">Doświadczenie i Zaufanie Klientów</h5>
                    <p>
                        Nasze doświadczenie oraz zaangażowanie pozwoliły nam zdobyć zaufanie <b className="bold">setek
                        zadowolonych klientów</b>.
                        Realizujemy zarówno małe, jak i duże projekty, dostosowując się do unikalnych potrzeb i
                        oczekiwań.
                        Naszą pracę wykonujemy solidnie, z najwyższą starannością, co przekłada się na trwałość i jakość
                        naszych produktów.
                    </p>
                </Col>
